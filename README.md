...
Las tasas de error para cada una de las señales con ruido que se simularón a SNR de -2dB, 3dB y de -2dB a 3dB, se pueden ver respectivamente en la parte inferior, se puede observar que para -2dB se tiene un error significativo pero, para los demás dBs el error es nulo.Esto se hizo de manera aleatoria y para esa simulación se obtuvo un error para SRN=-2dB
